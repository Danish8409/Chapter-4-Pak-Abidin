...
export default function Sidebar({ children, title }: SidebarProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-[#0D0D0D] text-gray-200">
      ...
      <nav className="bg-[#057781] text-white flex justify-between items-center px-6 py-3 shadow-lg relative">
<div className="flex items-center gap-3">
      ...
      <main className="flex-1 p-8">
        ...
        {pathname === "/" && (
          <div className="text-center">
            ...
            <div className="relative bg-[url('/image/motor.png')] bg-cover bg-center h-60 mt-4 rounded-md shadow-lg">
  ...
  <div className="absolute inset-0 flex flex-col justify-center items-center text-center">
    ...
    <h5 className="text-lg text-white">
     Pamerkan motor mu menggunakan jasa cinematic dan foto!
    </h5>
  </div>
</div>
      ...
      <footer className="bg-[#057781] text-gray-300 text-center py-4 text-sm">
        <p>
          Tiktok: @kentangoreng870 <br />
          Kontak: 0853-3616-7700
        </p>
      </footer>
    </div>
  );
